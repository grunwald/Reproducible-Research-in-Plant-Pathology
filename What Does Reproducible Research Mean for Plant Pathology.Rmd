...
* Kamvar et al. [@kamvar2015spatial] provides all data and R scripts to reproduce the analyses shown here are deposited publicly on github (https://github.com/grunwaldlab/ Sudden_Oak_Death_in_Oregon_Forests) and citable (Kamvar et al. 2014a). | Kamvar, Z. N., Larsen, M. M., Kanaskie, A. M., Hansen, E. M., and Gru ̈nwald, N. J. 2014a. Sudden_Oak_Death_in_Oregon_Forests: Spatial and temporal population dynamics of the sudden oak death epidemic in Oregon forests. Online publication. Zenodo. doi: 10.5281/zenodo.13007
